...
namespace Pregiato.API.Interfaces
{
    public interface IContractService
    {
     ...
     Task<ContractCommitmentTerm> GenerateContractCommitmentTerm(
          CreateRequestCommitmentTerm createRequestContractImageRights, Model model);
     Task<ContractBase> GenetayeContractImageRightsTerm(string querymodel);
     Task<List<ContractBase>> GenereteContractAgencyPhotographyMinorityAsync(
         GenerateContractsMinorityRequest generateContractsMinorityRequest, Model model);
     Task<ContractBase> GenerateContractAsyncMinorityAsync(GenerateContractsMinorityRequest generateContractsMinorityRequest,
         Model model, string contractType, Dictionary<string, string> parameters);
     ...
     Task<ContractBase> DefineContractAgencyAsync(ContractBase contract,
         CreateContractModelRequest contractModelRequest, Model model, string? contractType);
     Task<ContractCommitmentTerm> SaveContractCommitmentTer(CreateRequestCommitmentTerm requestCommitmentTerm, Stream pdfStream, Model model);
    }
}
