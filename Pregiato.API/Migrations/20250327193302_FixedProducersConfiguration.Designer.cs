...
namespace Pregiato.API.Migrations
{
    ...
    [Migration("20250327193302_FixedProducersConfiguration")]
    partial class FixedProducersConfiguration
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Pregiato.API.Models.ContractBase", b =>
                {
                    ...
                    b.HasOne("Pregiato.API.Models.Payment", null)
                        .WithOne("Contracts")
                        .HasForeignKey("Pregiato.API.Models.ContractBase", "PaymentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
